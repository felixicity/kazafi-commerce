      ...
      <div className="border-t border-b border-gray-200 lg:hidden bg-gray-50">
            ...
            >
                  <span className="flex items-center gap-2 text-black hover:text-black">
                        <IconShoppingBag size={18} className="text-gray-500" />
...
export const SelectField: React.FC<SelectFieldProps> = ({ id, options, className = "", label, defaultValue }) => {
      ...
      return (
            <Field className={`relative ${className}`}>
                  ...
                  <Select defaultValue={defaultVal} name={defaultVal}>
                        <SelectTrigger
                              id={id}
